...
namespace OOP_LB4_1_3_task
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Human human = new Human("Danil", "Ivanovich", "Male", 14);
            Debug.WriteLine($"This is class {human.GetType().Name}");
            human.Info();

            Employee employee = new Employee("Igor", "Doroshchuk", "Male", 15, "Director", 15989);
            ...
            Unit unit = new Unit("Cat", "Earth");
            unit.ShowInfo();

            Hero hero = new Hero("Kostya", "Cow", 1000, "Sickle", 11);
            hero.ShowInfo();

            Enemy enemy = new Enemy("Snake", "Mountain", 20000, "Water", 40);
            enemy.ShowInfo();
